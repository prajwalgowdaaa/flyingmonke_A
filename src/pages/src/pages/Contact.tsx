            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p><a href="mailto:info@flyingmonke.no" className="text-gray-700 hover:underline">info@flyingmonke.no</a></p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">Phone</h3>
                  <p><a href="tel:+4722001234" className="text-gray-700 hover:underline">+47 22 00 12 34</a></p>
                </div>
              </div>
            </div>
            <div>
